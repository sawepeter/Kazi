...
public class PaidJobsAdapter extends RecyclerView.Adapter<PaidJobsAdapter.MyViewHolder> {
    ...
    public PaidJobsAdapter(List<JobModelResponse> jobsResponseList, Context context, Fragment fragment) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PaidJobsAdapter.MyViewHolder(view);
    }
