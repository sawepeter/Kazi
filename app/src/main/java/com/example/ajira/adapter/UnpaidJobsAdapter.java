...
public class UnpaidJobsAdapter extends RecyclerView.Adapter<UnpaidJobsAdapter.MyViewHolder> {
    ...
    public UnpaidJobsAdapter(List<JobModelResponse> jobsResponseList, Context context, Fragment fragment) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UnpaidJobsAdapter.MyViewHolder(view);
    }
